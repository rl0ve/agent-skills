...
The canonical entries remain useful research sources. They are alternatives, not a sequential default chain. Natural Writing distills their strongest techniques and adds fact preservation, author-sample precedence, Claude-pattern coverage, channel routing, integrity checks, and the one-writer rule.
