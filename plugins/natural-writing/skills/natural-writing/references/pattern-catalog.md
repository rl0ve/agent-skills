...
| Clause-shape monotony | Four or more sentences in a row all carry a subordinate clause or hedge ("although," "which," "may," "arguably"), or four or more in a row are all short and unqualified | Recast one or two sentences to the other shape. A paragraph should alternate stretches of hedge and directness rather than commit to one for its whole length. |
