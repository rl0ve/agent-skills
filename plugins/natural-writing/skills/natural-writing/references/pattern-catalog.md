...
| Telegraphic speech | A spoken line compresses a mechanism into a noun-phrase list: "a clock, a warning when it is at risk and an escalation when it breaches." It reads fine and cannot be said convincingly, because a listener needs the connective tissue a reader can skip | Walk it through as a person would: an opener that buys a beat ("Now,"), the subject named rather than pronouned, and the mechanism in full - "when that SLA is at risk of being breached, it escalates to the right person automatically." Longer on purpose. Only applies to pieces meant to be spoken. **Judgment only, deliberately unlinted:** a detector was prototyped and rejected. Keying on a noun-phrase series of three or more with a subordinate clause produced 19 candidates across 40 talk tracks, nearly all of them deliberate rhetoric ("every one taken by a person, every one carrying its rationale"), and it missed the canonical case, which carries only one comma. Read the piece aloud instead. |
