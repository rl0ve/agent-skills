...
For a Claude Code workflow, the companion installer in this package turns the verified catalog into a transparent plan and can execute only the skills the user explicitly selects. It never treats discovery rank as install approval.
